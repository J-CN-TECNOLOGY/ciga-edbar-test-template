                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 text-right">
                                $ <span class="" id="boleta_iva                      ">0.00</span>
                            </div>
...
<script>
    ...
    function recalcularTotales(){
        ...
        var totalVenta = $("#totalVenta").html();
        var igv = parseFloat(totalVenta) * 0.19
        ...
        $("#boleta_iva").html(parseFloat(igv).toFixed(2));
        ...
        if (count > 0) {
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                $.ajax({
                    ...
                    processData: false,
                    success: function(respuesta) {
                      console.log("🚀 ~ file: ventas.php ~ realizarVenta~respuesta",respuesta); 
                        Swal.fire({
                            position: 'center',
                            icon: 'success',
                            title: respuesta,
